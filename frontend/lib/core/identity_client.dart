...
class IdentityClient {
  ...
  Future<Map<String, dynamic>> verifyPhoneOtp(String challengeId, String code) async =>
      _authorized('POST', '/identity/phone/verify', body: {
  ...
  Future<Map<String, dynamic>> completeOnboarding({
    ...
    return _authorized('POST', '/identity/onboarding', body: {
      'name': name,
      'phone': phone,
      'address': address,
      'age': age,
