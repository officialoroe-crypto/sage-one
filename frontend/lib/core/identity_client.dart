...
class IdentityClient {
  ...
  Future<Map<String, dynamic>> completeOnboarding({required String name, required String phone, required String address, required int age, required String helpIntent, required List<String> capabilities, required bool memoryConsent}) async => _authorized('POST', '/identity/onboarding', body: {'name': name, 'phone': phone, 'address': address, 'age': age, 'basic_info': <String, dynamic>{}, 'help_intent': helpIntent, 'capabilities': capabilities, 'memory_consent': memoryConsent});
