...
class Artifact(Base):
    ...
    artifact_metadata: Mapped[str | None] = mapped_column(
        "metadata",
        Text,
        nullable=True
    )
...
class RecoveryAttempt(Base):
    ...
    failed_attempt_id: Mapped[str | None] = mapped_column(
        String,
        nullable=True
    )
...
class ActionLog(Base):
    ...
    permission_allowed: Mapped[int] = mapped_column(
        Integer,
        nullable=False
    )

    permission_reason: Mapped[str | None] = mapped_column(
        Text,
        nullable=True
    )
